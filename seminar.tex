...
\begin{frame}
    ...
    \pause
    If all $\mathcal{R}$-systems satisfy the sequent we write 
...
Very powerful, allows a much more advanced level of \emph{metaprogramming.} 

At the core 
of Maude extensions (Full Maude, Real Time Maude,...) and tools (model checker, theorem proving,...)
